#!/bin/bash
# Portal Unified Launcher — Linux WSL2
...
case "$COMMAND" in
  up)
    echo "=== Portal Starting (Linux WSL2) ==="

    # 1. Ensure Ollama is running (WSL2 — no systemd by default)
    ...
    bash "$PORTAL_ROOT/hardware/linux-wsl2/launch_router.sh"
