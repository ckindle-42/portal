...
### 0A — Confirm Access & Environment
```bash
ls -la
python3 --version
pip list | grep -E "fastapi|uvicorn|httpx|pydantic|ollama|anthropic"
...
- **NEVER** add optional packages to core dependencies
