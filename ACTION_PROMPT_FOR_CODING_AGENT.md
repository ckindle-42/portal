...
**Generated:** 2026-03-02 (delta run v13)
...
Source: `src/portal/` (98 Python files).
Tests: `tests/` (915 tests currently passing).
...
5. Run baseline verification:
   ...
   python3 -m pytest tests/ -v --tb=short   # expect all PASS
   ```
...
- TASK-53: K8s health probes wired
- TASK-54: Metrics port corrected to :8081
- TASK-55: MLX env vars added to .env.example
- TASK-56: Knowledge base env vars added to .env.example
- ROAD-F05: Structured Config Hot-Reload implemented
- Auto-Pull Models: ModelPuller class for Ollama auto-download
- Docker Image Updates: OpenWebUI/LibreChat use latest

**Current state:** 915 tests passing, 0 mypy errors, 0 lint violations.
