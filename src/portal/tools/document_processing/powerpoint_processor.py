...
async def example_powerpoint_operations():
    """Example PowerPoint operations"""
    
    tool = PowerPointProcessorTool()
    
    print("=" * 60)
    print("PowerPoint Processor - Examples")
    print("=" * 60)
    ...
    result = await tool.execute({
        "action": "create",
        "file_path": "/tmp/quarterly_report.pptx",
        "title": "Q4 2025 Results",
        "content": "Quarterly Business Review"
    })
    print(f"Result: {result}")
    
    # Example 2: Add content slide
    print("\n2. Add Content Slide")
    result = await tool.execute({
        "action": "add_slide",
        "file_path": "/tmp/quarterly_report.pptx",
    ...
    result = await tool.execute({
        ...
        "chart_data": {
            ...
            "series": [
                {"name": "Revenue", "values": [100, 120, 140, 175]},
                {"name": "Costs", "values": [60, 70, 80, 90]}
            ]
        }
    })
    print(f"Result: {result}")
...
if __name__ == "__main__":
    if not PPTX_AVAILABLE:
        ...
        print("✅ PowerPoint processor available")
        print("\nRun examples:")
        print("  python powerpoint_processor.py")
