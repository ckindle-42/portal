...
TOKENS_PER_SECOND = Histogram("portal_tokens_per_second", "Tokens/sec during completion", buckets=(1, 5, 10, 20, 40, 80))
TTFT_MS = Histogram("portal_ttft_ms", "Time to first token", buckets=(10, 50, 100, 250, 500, 1000, 2000, 5000))
